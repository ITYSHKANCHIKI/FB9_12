  ...
  return (
    ...
    >
      ...
      <div className="form-container">
        ...
        />
        <button className="button-green" onClick={handleAddProduct}>Добавить</button>
      </div>
      ...
      {products.map((product) => (
        <li key={product.id} className="app-product-card">
          ...
          <button className="button-yellow" onClick={() => handleEditClick(product)}>
            Редактировать
          </button>
          <button className="button-red" onClick={() => handleDeleteProduct(product.id)}>
            Удалить
          </button>
        </li>
      ))}
